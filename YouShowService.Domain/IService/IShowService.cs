...
namespace YouShowService.Domain.IService
{
    public interface IShowService
    {
        ...
        Task<(List<YouShowDTO> dto, long count)> PagingQueryByUserIdAsync(long userId, int pageIndex, int pageSize);
        Task<(List<YouShowDTO> dto, long count)> PagingQueryByLikeOrStarAsync(long userId, string like_or_star,int pageIndex, int pageSize);
