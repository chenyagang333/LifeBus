...
namespace YouShowService.Infrastructure.Service
{
    public class ShowService : IShowService
    {
        ...
        public async Task<(List<YouShowDTO> dto, long count)> PagingQueryByUserIdAsync(long userId, int pageIndex, int pageSize)
        {
        ...
        public async Task<(List<YouShowDTO> dto, long count)> PagingQueryByLikeOrStarAsync(long userId, string like_or_star, int pageIndex, int pageSize)
        {
            long[] youshowIds = [];
            long count;
